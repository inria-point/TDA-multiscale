...
PAIRS = [("polished", "chained"), ("chained", "absurd"),
         ("chained", "flat")]
...
ROW = ["правка фактов на гладком тексте",
       "абсурд странными словами",
       "абсурд обычными словами"]
...
def main():
    ...
    grid(W, [("chained", "absurd")], "halluc_scatter_absurd.png",
         ...
         "Каждая точка — один вопрос; диагональ = размерность не сдвинулась")
    grid(W, [("chained", "flat")], "halluc_scatter_flat.png",
         "Абсурд обычными словами: токенизация не сдвинута.\n"
         "Каждая точка — один вопрос; диагональ = размерность не сдвинулась")
